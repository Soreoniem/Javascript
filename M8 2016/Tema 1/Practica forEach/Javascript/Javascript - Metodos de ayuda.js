/**
 Metodos de ayuda versión: 2.3.2
...
__Metodos__
	...
	✪ getCookie( variable )
		...
		📖 Ejemplo:	setCookie( "usuario" );

		NOTA:
			1. return:	Valor de la variable o coockie no encontrada.


	✪ setCookie( variable, texto )
		► variable	▬ (String)	Nombre de la variable.
		► texto		▬ (String)	Valor de la variable.
...
function getCookie( variable ){
	...
	error("getCookie", "", variable, "La cookie no existe o no está disponible");
}
